...
public class Robot extends TimedRobot {
  ...
  static private double WHEEL_DIAMETER = 0.1542;
  static private double ENCODER_EDGES_PER_REV = 1365.333;
  ...
  public void robotInit() {
    ...
    rightMaster = new WPI_TalonSRX(20);
    rightMaster.setInverted(false);
    rightMaster.setSensorPhase(false);
    rightMaster.setNeutralMode(NeutralMode.Brake);

    WPI_TalonSRX leftSlave0 = new WPI_TalonSRX(5);
    leftSlave0.setInverted(true);
    leftSlave0.follow(leftMaster);
    leftSlave0.setNeutralMode(NeutralMode.Brake);
    WPI_TalonSRX leftSlave1 = new WPI_TalonSRX(8);
    leftSlave1.setInverted(true);
    leftSlave1.follow(leftMaster);
    leftSlave1.setNeutralMode(NeutralMode.Brake);

    WPI_TalonSRX rightSlave0 = new WPI_TalonSRX(11);
