...
public class Drivetrain extends SubsystemBase {
  ...
  public void driveStraight(double distance, boolean gear) {
    ...
    if (gear) {
      ...
      shiftHi();
      target_Distance = distance * DriveConstants.kSensorUnitsPerRotationHi / DriveConstants.kInchesPerRotation;
      target_Heading = 0;
      ...
      shiftLow();
      target_Distance = distance * DriveConstants.kSensorUnitsPerRotationLo / DriveConstants.kInchesPerRotation;
      target_Heading = 0;
    }
  ...
  */
  ...
  public double getDistance() {
    ...
    return i * DriveConstants.kInchesPerRotation / DriveConstants.kSensorUnitsPerRotationLo;
  }
